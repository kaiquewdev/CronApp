...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by kaique",
		deployType: "development",
		description: "not specified",
		guid: "f0ddfe72-f013-40ac-9f89-f6ea92a1e214",
		id: "Cron",
		name: "Cron",
		names: {},
		publisher: "kaique",
		url: "http://kaiquewdev.nodester.com",
		version: "1.0"
	},
	has: {
	...
	project: {
		id: "com.nodester.kaiquewdev",
		name: "Cron"
	},
	ti: {
		buildHash: "999c68a",
		buildDate: "04/12/12 16:33",
		filesystem: {
			registry: "ondemand"
		},
		theme: "default",
...
p.setString("acs-api-key-production","gKvJ3rWbsFgkHaGBXB62pkDRSr39s5oq");
p.setString("acs-api-key-development","WQgr3aGBpUj3dHrkxafkQoQXFrxVLakE");
p.setString("acs-oauth-secret-development","tdnLCuXPR67F3sCZ0kGq6AoBJzzJtIbr");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","B13LYxhbwX5FJf1CMnrEOkpWGvQsIy4B");
p.setString("acs-oauth-key-development","Fm6i7tSXFmZfaGZ4tPA8ain3nEEQ9DCT");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","7fZCPuB9OsOWGRpw0mbmqCPwCCazkxRY");
});
